# DummyDroidStubGen
DummyDroidStubGen (**DDSG**) is a simple, yet versatile linux application to generate *"Dummy"* packages (known as *"Stubs"*) that serve as entry points for another application.
...
## Compatibility
#### OS Version: Android 5.0 (Lollipop) [Minimum API Level: 21]
