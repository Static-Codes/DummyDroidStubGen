...
## Restrictions
DDSG has a set of blacklisted apps that cannot be used to create a stub. For more information on the blacklist, click [here](./docs/FAQ.md#q-why-are-there-restrictions-on-the-apps-ddsg-can-open)
